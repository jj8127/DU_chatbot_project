...
# 환경변수로 CUDA 사용 설정 (2번, 3번, 4번 GPU 사용)
os.environ["CUDA_VISIBLE_DEVICES"] = "1,2,3"  # GPU 인덱스는 0부터 시작

# 모델 정의 (예시: 간단한 모델을 정의한 후, DataParallel을 적용)
class SimpleModel(torch.nn.Module):
    def __init__(self):
        super(SimpleModel, self).__init__()
        self.fc = torch.nn.Linear(10, 10)  # 예시로 Linear 레이어 추가

    def forward(self, x):
        return self.fc(x)

#/home/du3/Desktop/DU_chatbot_project-main_ori/Model/Modelfile
RAG_PROMPT_TEMPLATE = """
